        ...
        <table class="responsive-table highlight col s12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="waves-effect waves-light btn red accent-3" href="#"><i class="material-icons">delete</i></a>
                        <a class="waves-effect waves-light btn modal-trigger light-blue lighten-2" href="#edit"><i class="material-icons">edit</i></a>
                            <div id="edit" class="modal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s12">
                                        <input placeholder="Hobby" id="hobi" type="text" class="validate">
                                        <label for="hobi">Hobby</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <input placeholder="Category" id="kategori" type="text" class="validate">
